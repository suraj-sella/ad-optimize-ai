...
const UploadScreen = ({ onUploadSuccess }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      {/* Upload Area and Requirements Side by Side */}
        ...
        <div className="flex-1 min-w-[260px]">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Ensure your CSV includes these headers:
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                <li>Matched product</li>
                <li>Impressions</li>
                <li>Clicks</li>
                <li>CTR</li>
                <li>Spend(USD)</li>
              ...
              <div className="mt-4">
                <a href="/sample-ad-csv.csv" download className="inline-block">
              ...
              <div className="mt-4 text-xs text-muted-foreground">
                <p>• File must be in CSV format and less than 100MB.</p>
                <p>• All columns are required for accurate analysis.</p>
              </div>
            </CardContent>
          </Card>
        </div>
